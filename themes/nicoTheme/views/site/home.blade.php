            ...
            <div class="col-md-6 col-lg-7 pl-lg-5 py-5">
                <div class="row justify-content-start pb-3">
                    <div class="col-md-12 heading-section ftco-animate">
                        ...
                        {!! fragment("about_me") !!}
                        <div>
                            <a href="{{base_url('about')}}">Read my entire history...</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="media block-6 services d-block ftco-animate">
                            ...
                            <div class="media-body">
                                ...
                                <p>I build with your goals in mind, whether you want a simple flexible web application</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="media block-6 services d-block ftco-animate">
                            <div class="icon"><span class="flaticon-analysis"></span></div>
                            <div class="media-body">
                                <h3 class="heading mb-3">Experience Design</h3>
                                <p>I design your application to be easy to use, while guiding users towards the end goal.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row justify-content-center pb-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
                ...
                <p>I create beautiful websites your users will love with this tools.</p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row justify-content-center py-5 mt-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
                ...
                <p>I work with you from start to finish to make sure your goals are reached and your users are happy.</p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
            <div class="col-md-7 heading-section text-center ftco-animate">
                ...
                <p>See my new discoveries, latest projects and featured blogs.</p>
            </div>
        </div>
        <div class="row d-flex">
            ...
            <div class="col-md-4 d-flex ftco-animate">
                ...
                <a href="{{base_url($blog->path)}}" class="block-20" style="background-image: url(<?php echo base_url($blog->thumbnail_image->file_full_path) ?>);">
                </a>
                @elseif (isset($blog->imagen_file))
                <a href="{{base_url($blog->path)}}" class="block-20" style="background-image: url(<?php echo base_url($blog->imagen_file->file_full_path) ?>);">
                </a>
                @else
                <a href="{{base_url($blog->path)}}" class="block-20" style="background-image: url(<?php echo base_url(getThemePublicPath()) ?>images/image_1.jpg);">
                </a>
                                @endif
                    <div class="text mt-3 float-right d-block">
                        <div class="d-flex align-items-center mb-3 meta">
                            <p class="mb-0">
                                <span class="mr-2">{{time_ago($blog->date_publish)}}</span>
                                <a href="{{base_url('blog/author/' . $blog->user->username)}}" class="mr-2">{{ $blog->user->user_data["nombre"] . ' ' . $blog->user->user_data["apellido"]}}</a>
                                <!-- <a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a> -->
                            </p>
                        </div>
                        <h3 class="heading"><a href="{{base_url($blog->path)}}">{{ $blog->title }}</a>
                        </h3>
                        <p>{{character_limiter(strip_tags($blog->content), 120)}}</p>
                    </div>
                </div>
            </div>
            @empty
        ...
        <div class="row justify-content-center mt-2 pt-2">
            <div class="col-md-7 heading-section text-center ftco-animate">
                <a href="{{base_url('/blog')}}"><span class="subheading">View All</span></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section text-center ftco-animate">
                ...
                <p>Get a fast web application designed to grow with your business</p>
            </div>
        </div>
        <div class="row no-gutters block-9">
            <div class="col-md-6 order-md-last d-flex">
                {!! render_form('contact_me') !!}
