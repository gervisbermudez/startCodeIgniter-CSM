...
-- Dumping data for table start_cms.categories: ~9 rows (approximately)
...
-- Dumping structure for table start_cms.file
...
-- Dumping data for table start_cms.file: ~0 rows (approximately)
DELETE FROM `file`;
...
INSERT INTO `form_content` (`form_content_id`, `form_custom_id`, `form_tab_id`, `date_create`, `date_update`, `user_id`, `status`) VALUES
	(9, 1, 1, '2020-08-16 23:09:13', '2020-08-16 23:09:13', 1, 1);
...
-- Dumping data for table start_cms.form_content_data: ~2 rows (approximately)
...
INSERT INTO `form_content_data` (`form_custom_data_id`, `form_content_id`, `form_field_id`, `form_value`, `date_create`, `date_update`, `status`) VALUES
	(7, 9, 1, '{"title":"Diagrama do Ciclo de Vida Vue.js"}', '2020-08-16 23:09:13', '2020-08-16 23:09:13', 1),
	(8, 9, 2, '{"title":"Abaixo est\\u00e1 um diagrama para o ciclo de vida da inst\\u00e2ncia. Voc\\u00ea n\\u00e3o precisa entender completamente tudo o que est\\u00e1 acontecendo neste momento, mas conforme voc\\u00ea aprender e construir mais coisas, este diagrama ser\\u00e1 uma refer\\u00eancia \\u00fatil."}', '2020-08-16 23:09:13', '2020-08-16 23:09:13', 1);
...
INSERT INTO `form_custom` (`form_custom_id`, `form_name`, `form_description`, `date_create`, `date_update`, `user_id`, `status`) VALUES
	(1, 'Card', 'Projects Card', '2020-08-16 21:11:34', '2020-08-16 21:11:34', 1, 1);
...
INSERT INTO `form_fields` (`form_field_id`, `form_tab_id`, `field_name`, `displayName`, `icon`, `component`, `date_create`, `date_update`, `status`) VALUES
	(1, 1, 'title', 'Titulo', 'format_color_text', 'formFieldTitle', '2020-08-16 21:11:34', '2020-08-16 21:11:34', 1),
	(2, 1, 'title', 'Titulo', 'format_color_text', 'formFieldTitle', '2020-08-16 21:11:35', '2020-08-16 21:11:35', 1);
/*!40000 ALTER TABLE `form_fields` ENABLE KEYS */;

-- Dumping structure for table start_cms.form_fields_data
...
-- Dumping data for table start_cms.form_fields_data: ~8 rows (approximately)
...
INSERT INTO `form_fields_data` (`form_field_config_id`, `form_field_id`, `_key`, `_value`, `date_create`, `date_update`, `status`) VALUES
	(1, 1, 'fieldPlaceholder', 'card_name', '2020-08-16 21:11:34', '2020-08-16 21:11:34', 1),
	(2, 1, 'fieldID', '1uXvhbj8Sc', '2020-08-16 21:11:34', '2020-08-16 21:11:34', 1),
	(3, 1, 'fieldName', 'card_name', '2020-08-16 21:11:35', '2020-08-16 21:11:35', 1),
	(4, 1, 'fielApiID', 'card_name', '2020-08-16 21:11:35', '2020-08-16 21:11:35', 1),
	(5, 2, 'fieldPlaceholder', 'card_description', '2020-08-16 21:11:35', '2020-08-16 21:11:35', 1),
	(6, 2, 'fieldID', '8y9rIkmTU8', '2020-08-16 21:11:35', '2020-08-16 21:11:35', 1),
	(7, 2, 'fieldName', 'card_description', '2020-08-16 21:11:35', '2020-08-16 21:11:35', 1),
	(8, 2, 'fielApiID', 'card_description', '2020-08-16 21:11:35', '2020-08-16 21:11:35', 1);
...
INSERT INTO `form_tabs` (`form_tab_id`, `form_custom_id`, `tab_name`, `date_create`, `date_update`, `status`) VALUES
	(1, 1, 'Tab 1', '2020-08-16 21:11:34', '2020-08-16 21:11:34', 1);
...
-- Dumping data for table start_cms.page_data: ~0 rows (approximately)
DELETE FROM `page_data`;
/*!40000 ALTER TABLE `page_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `page_data` ENABLE KEYS */;

-- Dumping structure for table start_cms.page_type
...
-- Dumping data for table start_cms.page_type: ~3 rows (approximately)
...
-- Dumping data for table start_cms.user_data: ~12 rows (approximately)
