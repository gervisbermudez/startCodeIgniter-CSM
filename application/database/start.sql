...
-- Volcando datos para la tabla start_cms.file: ~603 rows (aproximadamente)
DELETE FROM `file`;
...
INSERT INTO `file` (`file_id`, `rand_key`, `file_name`, `file_path`, `file_type`, `parent_name`, `user_id`, `shared_user_group_id`, `share_link`, `featured`, `date_create`, `date_update`, `status`) VALUES
	...
	(1288, 'pq2bca8QrmyvBwYk', 'diciembre-2018-materialize', './uploads/', 'jpg', 'uploads', 1, 1, 'admin/archivos/shared_file/pq2bca8QrmyvBwYk', 0, '2020-11-26 13:40:51', '2020-11-26 13:40:51', 1),
	(1289, 'rAEelgDShiL0IG42', '269638_08f4_3', './uploads/', 'jpg', 'uploads', 1, 1, 'admin/archivos/shared_file/rAEelgDShiL0IG42', 0, '2020-11-26 19:05:21', '2020-11-26 19:05:21', 1);
...
-- Volcando datos para la tabla start_cms.logger: ~0 rows (aproximadamente)
DELETE FROM `logger`;
...
-- Volcando datos para la tabla start_cms.page: ~4 rows (aproximadamente)
DELETE FROM `page`;
...
INSERT INTO `page` (`page_id`, `path`, `template`, `title`, `subtitle`, `content`, `page_type_id`, `user_id`, `visibility`, `categorie_id`, `subcategorie_id`, `status`, `layout`, `mainImage`, `date_publish`, `date_update`, `date_create`, `date_delete`) VALUES
	...
	(102, 'typescript-the-best-resources-to-learn-it', 'default', 'TypeScript: The Best Resources to Learn It', '', 'Content of the page...', 1, 1, 1, 0, 0, 2, 'default', NULL, '2020-11-26 23:13:12', NULL, '2020-11-26 23:13:12', '2020-11-26 23:03:44'),
...
-- Volcando datos para la tabla start_cms.page_data: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla start_cms.site_config: ~21 rows (aproximadamente)
...
INSERT INTO `user` (`user_id`, `username`, `password`, `email`, `lastseen`, `usergroup_id`, `status`, `date_create`, `date_update`, `date_delete`) VALUES
	(1, 'gerber', '$2y$10$Qqz3Uy0KGbgHq7WNP2wvsOYkCBFjsFgtbT2sYRx8nYN/9m7IKmQ5G', 'gerber@gmail.com', '2020-11-26 22:15:31', 1, 1, '2020-03-01 16:11:25', '2020-11-17 08:18:25', NULL),
