...
INSERT INTO `user` (`user_id`, `username`, `password`, `email`, `lastseen`, `usergroup_id`, `status`, `date_create`, `date_update`, `date_delete`) VALUES
	(1, 'gerber', '$2y$10$Qqz3Uy0KGbgHq7WNP2wvsOYkCBFjsFgtbT2sYRx8nYN/9m7IKmQ5G', 'gerber@gmail.com', '2020-11-23 12:25:47', 1, 1, '2020-03-01 16:11:25', '2020-11-17 08:18:25', NULL),
	...
	(3, 'nestor', '$2y$10$todx7BAG8S1cSoKOYxtrPuF412C1FvKuuaJWU1jNb/28ahu0a30GW', 'nestor@email.com', '2020-11-23 12:29:52', 3, 1, '2020-09-20 19:22:31', '2020-11-17 08:43:31', NULL);
...
-- Volcando datos para la tabla start_cms.usergroup_permisions: ~225 rows (aproximadamente)
