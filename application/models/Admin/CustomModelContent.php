...
class CustomModelContent extends MY_Model
{
    ...
    public $hasOne = [
        ...
        'custom_model' => ['custom_model_id', 'Admin/CustomModel', 'CustomModel'],
    ];
    ...
    public function filter_results($collection = [])
    {
        ...
        $this->load->model('Admin/CustomModelContentData');
            ...
            if (isset($value->custom_model->tabs)) {
                foreach ($value->custom_model->tabs as $index => $tab) {
                    foreach ($tab->custom_model_fields as $form_field) {
                        $Custom_model_content_data = new CustomModelContentData();
