...
$route['admin/notifications'] = 'admin/NotificationsController';
$route['admin/notifications/(.+)'] = 'admin/NotificationsController/$1';
//Pages system
...
$route['admin/events/calendar'] = 'admin/CalendarController';
...
$route['api/v1/notifications/read-all'] = 'api/v1/NotificationsController/read_all';
$route['api/v1/notifications/(.+)'] = 'api/v1/NotificationsController/$1';
$route['api/v1/notifications'] = 'api/v1/NotificationsController';
