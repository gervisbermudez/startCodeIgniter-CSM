						...
						<div class="col m6 s12 l4" id="<?php echo $itemid; ?>">
							<div class="card" style="overflow: visible">
								...
								<ul id='<?php echo $ddmid ?>' class='dropdown-content'>
									...
									<li><a href="<?php echo base_url('admin/videos/editar/'.$video['id']); ?>" title="Editar">Editar</a></li>
									<?php endif ?>
									<?php if (3 > $this->session->userdata('level')): ?>
									<li><a href="#<?php echo $modalid; ?>" class="modal-trigger"  data-action-param='{"id":"<?php echo $video['id'] ?>", "table":"video"}' data-url="admin/videos/fn_ajax_delete_data" data-ajax-action="inactive" data-target-selector="<?php echo "#$itemid"; ?>">Eliminar</a></li>
									<?php endif ?>
									<li><a href="<?php echo base_url('admin/videos/ver/'.$video['id']) ?>" title="Ver">Ver</a>
								</li>
							</ul>
...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
	...
	<ul>
	    <li><a class="btn-floating yellow darken-1 tooltipped" data-position="left" data-delay="50" data-tooltip="Categorias"  href="<?php echo base_url('admin/categorias/filter/video/') ?>"><i class="material-icons">insert_chart</i></a></li>
	</ul>
</div>
