...
<div class="container">
	<div class="row mensaje-container">
		...
		<div class="col m1 s2 folders">
			<a href="#" class="tooltipped  folder" data-folder="1" data-position="right" data-delay="50"
				data-tooltip="Inbox"><i class="material-icons">inbox</i></a>
			<a href="#" class="tooltipped folder" data-folder="2" data-position="right" data-delay="50"
				data-tooltip="Archived"><i class="material-icons">archive</i></a>
			<a href="#" class="tooltipped folder" data-folder="3" data-position="right" data-delay="50"
				data-tooltip="Send"><i class="material-icons">send</i></a>
			<a href="#" class="tooltipped folder" data-folder="7" data-position="right" data-delay="50"
				data-tooltip="Drafts"><i class="material-icons">drafts</i></a>
			<a href="#" class="tooltipped folder" data-folder="6" data-position="right" data-delay="50"
				data-tooltip="Starred"><i class="material-icons">grade</i></a>
			<a href="#" class="tooltipped folder" data-folder="4" data-position="right" data-delay="50"
				data-tooltip="Deleted"><i class="material-icons">delete</i></a>
			<a href="#" class="tooltipped folder" data-folder="5" data-position="right" data-delay="50"
				data-tooltip="Spam"><i class="material-icons">report</i></a>
		</div>
