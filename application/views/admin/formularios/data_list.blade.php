			...
			<div class="col s12 m4" v-for="(form, index) in filterForms" :key="index">
					<div class="card page-card">
						...
						<div class="card-content">
							<div>
								<span class="card-title"><a :href="base_url(form.path)" target="_blank">@{{form.form_name}}</a> <i v-if="form.visibility == 1" class="material-icons tooltipped"
...
<script src="{{base_url('public/js/components/DataFormLists.min.js')}}"></script>
@endsection