	...
	<div class="row">
		<form action="<?php echo $action; ?>" method="post" id="form" class="col s12 m10 l10">
			...
			<div class="input-field">
				...
				<input type="text" id="nombre" name="nombre_form" required="required"
					value="<?php echo element('nombre', $categoria, ''); ?>">
			</div>
			<div id="introduction" class="section scrollspy">
				<label for="id_cazary">Descripcion de la categoria:</label>
				<div class="input-field">
					<textarea id="id_cazary"
						name="descripcion_form"><?php echo element('description', $categoria, ''); ?></textarea>
				</div>
				<br>
			</div>
			<div class="input-field">
				<select name="tipo_form">
					...
					<option value="Video" <?php if (element('tipo', $categoria, '')=="Video"): ?>selected<?php endif ?>>
						Video</option>
					<option value="Evento"
						<?php if (element('tipo', $categoria, '')=="Evento"): ?>selected<?php endif ?>>Evento</option>
					<option value="Album" <?php if (element('tipo', $categoria, '')=="Album"): ?>selected<?php endif ?>>
						Album</option>
				</select>
			...
			<div class="input-field">
				<div class="switch">
					<label>
						No publicado
						<input type="checkbox" name="status_form" value="1"
							<?php if (element('status', $categoria, '')=="1"): ?> checked="checked" <?php endif ?>>
