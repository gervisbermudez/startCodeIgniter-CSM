		...
		<div class="col s12">
			...
			<ul class="collection">
				...
				<?php 
					...
					?>
				<li class="collection-item" id="<?php echo $itemid; ?>">
					<div><?php echo $value['nombre'] ?><a href="#!" class="secondary-content"><i
								class="material-icons">send</i></a>
						<a class='dropdown-button secondary-content' href='#' data-activates='<?php echo $ddmid ?>'><i
								class="material-icons">more_vert</i></a>
						<ul id='<?php echo $ddmid ?>' class='dropdown-content'>
							<li><a href="#!">Ver en la web</a></li>
							<?php if (4 > $this->session->userdata('level')): ?>
							<li><a href="<?php echo base_url('admin/categorias/editar/'.$value['id']); ?>">Editar</a>
							</li>
							<?php endif ?>
							<?php if (3 > $this->session->userdata('level')): ?>
							<li><a href="#<?php echo $modalid;?>" class="modal-trigger"
									data-action-param='{"id":"<?php echo $value['id'] ?>", "table":"categorias"}'
									data-url="admin/categorias/fn_ajax_delete_data/" data-ajax-action="inactive"
...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
	<a class="btn-floating btn-large red waves-effect waves-teal btn-flat new tooltipped" data-position="left"
		data-delay="50" data-tooltip="Crear categoria" href="<?php echo base_url('admin/categorias/nueva/') ?>">
