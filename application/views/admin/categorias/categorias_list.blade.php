				...
				<table>
					...
					<tbody>
						<tr v-for="(categorie, index) in filterCategories" :key="index">
							...
							<td>
								<i v-if="categorie.status == 1" class="material-icons tooltipped" data-position="left"
			...
			<div class="col s12 m4" v-for="(categorie, index) in filterCategories" :key="index">
					<div class="card page-card">
						...
						<div class="card-content">
							<div>
								<span class="card-title"><a :href="base_url(categorie.name)" target="_blank">@{{categorie.name}}</a> <i v-if="categorie.visibility == 1" class="material-icons tooltipped"
