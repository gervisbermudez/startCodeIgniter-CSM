        ...
        <div v-cloak v-if="!loader" class="col s12 m10 l10">
            <div id="initialization" class="section scrollspy">
                ...
                <div class="input-field ">
                    ...
                    <span class="helper-text" :data-error="form.fields.currentPassword.errorText" data-success="<?php echo lang('valid'); ?>"><?php echo lang('password_requirements'); ?></span>
                </div>
                <div class="input-field ">
                    ...
                    <span class="helper-text" :data-error="form.fields.password.errorText" data-success="<?php echo lang('valid'); ?>"><?php echo lang('password_requirements'); ?></span>
                </div>
                <div class="input-field ">
                    ...
                    <label><?php echo lang('repeat_password'); ?></label>
                    <span class="helper-text" :data-error="form.fields.password2.errorText" data-success="<?php echo lang('valid'); ?>"><?php echo lang('password_requirements'); ?></span>
                </div>
                <br>
                <br>
                <div class="row userform">
                    <div class="col s12" id="buttons">
                        <a href="<?php echo base_url('admin/users/'); ?>" class="btn btn-default waves-effect waves-teal btn-flat"><?php echo lang('cancel'); ?></a>
                        <button type="submit" class="btn btn-primary waves-effect waves-teal" :class="{disabled: !btnEnable}"  @click="save();"><?php echo lang('save'); ?></button>
                    </div>
                </div>
            </div>
        </div>
