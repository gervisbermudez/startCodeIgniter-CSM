    ...
    <div class="row">
        ...
        <div v-cloak v-if="!loader" class="col s12 m10 l10">
            <div id="initialization" class="section scrollspy">
                ...
                <div class="input-field ">
                    ...
                    <span class="helper-text" :data-error="form.fields.password.errorText" data-success="Valid">Must contain uppercase, lowercase, numbers and a special character</span>
                </div>
                <div class="input-field">
            ...
            <div id="structure" class="section scrollspy">
                ...
                <div class="input-field">
                    <input maxlength="20" type="text" id="apellido" name="apellido" value="" @change="form.validateField('apellido')" :class="{ valid: form.fields.apellido.touched && form.fields.apellido.valid, invalid: !form.fields.apellido.valid }" v-model="form.fields.apellido.value"><label for="apellido">Last Name:</label>
                    <span class="helper-text" :data-error="form.fields.apellido.errorText"></span>
                </div>
                <div class="input-field">

                    <input maxlength="200" type="text" id="direccion" name="direccion" value="" @change="form.validateField('direccion')" :class="{ valid: form.fields.direccion.touched && form.fields.direccion.valid, invalid: !form.fields.direccion.valid }" v-model="form.fields.direccion.value"><label for="direccion">Address:</label>
                    <span class="helper-text" :data-error="form.fields.direccion.errorText"></span>
                </div>
                <div class="input-field">
                    <input maxlength="50" type="text" id="telefono" name="telefono" value="" @change="form.validateField('telefono')" :class="{ valid: form.fields.telefono.touched && form.fields.telefono.valid, invalid: !form.fields.telefono.valid }" v-model="form.fields.telefono.value"><label for="telefono">Phone:</label>
                ...
                <div class="row userform">
                    <div class="col s12" id="buttons">
                        <a href="<?php echo base_url('admin/users/'); ?>" class="btn btn-default waves-effect waves-teal btn-flat">{{ lang('btn_cancel') }}</a>
                        <button type="submit" class="btn btn-primary waves-effect waves-teal" @click="save();">{{ lang('btn_save') }}</button>
                    </div>
                </div>
        ...
        <div v-cloak v-if="!loader" class="col hide-on-small-only m2 l2">
            <ul class="section table-of-contents tabs-wrapper">
                <li><a href="#initialization">Profile</a></li>
                <li><a href="#structure">Information</a></li>
            </ul>
        </div>
    </div>
</div>
