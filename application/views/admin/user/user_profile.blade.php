                                    ...
                                    <div class="card">
                                            <div class="card-header">
                                                ...
                                                <ul :id='"custom_model_id" + element.custom_model_id' class='dropdown-content'>
                                                    <li><a :href="base_url('admin/custommodels/items/' + element.custom_model_id)"> {{ lang('collections_add_item') }}</a></li>
                                                    <li><a :href="base_url('admin/custommodels/editForm/' + element.custom_model_id)"> {{ lang('btn_edit') }}</a></li>
                                                </ul>
                                            </div>
                                            <div class="card-content">
                                            ...
                                            <div class="card-action">
                                                <a :href="base_url('admin/custommodels/items/' + element.custom_model_id)">{{ lang('collections_view_items') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </template>
