						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="mailto:<?php echo $Suscriptor['email'] ?>"><i
												class="fa fa-envelope-o"></i> <?php echo $array['email'] ?></a></td>
									<td><?php echo $Suscriptor['recibir'] ?></td>
									<td><?php echo $Suscriptor['fecha'] ?></td>
									<td><?php echo $Suscriptor['estatus'] ?></td>
									<?php if ($this->session->userdata('type') == "Administrador"): ?>
									<td><a href="<?php echo $base_url.'index.php/Admin/Suscriptores/Eliminar/'.$array['id'] ?>"
