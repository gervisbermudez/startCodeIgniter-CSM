					...
					<div class="switch">
						<label>
							...
							<input type="checkbox" class="change_state" name="status"
								data-url="admin/galeria/fn_ajax_change_state/"
								data-action-param='{"id":"<?php echo $album[0]['id']; ?>", "table":"album"}'
								<?php if ( $album[0]['status'] == '1'): ?> checked="checked" <?php endif ?>>
							<span class="lever"></span>
							Publicado
						</label>
						<a class='dropdown-button right' href='#' data-activates='albumoptions'><i
						...
						<ul id="albumoptions" class='dropdown-content'>
							...
							<li><a href="#<?php echo $modalid;?>" class="modal-trigger"
									data-action-param='{"id":"<?php echo $album[0]['id'] ?>", "table":"album"}'
									data-url="admin/galeria/fn_ajax_delete_data/" data-url-redirect="admin/galeria/"
									data-ajax-action="inactive">Eliminar</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="card">
							<div class="card-image">
								<img class="materialboxed"
									src="<?php echo base_url('public/img/gallery/'.$album[0]['path'].'/'.$value['nombre']); ?>">
							</div>
							<div class="card-content">
								...
								<ul id='<?php echo $ddmid  ?>' class='dropdown-content'>
									<li><a href="#<?php echo $modalid_2;?>" class="modal-trigger"
											data-action-param='{"id":"<?php echo $value['id'] ?>", "table":"album_items"}'
											data-url="admin/galeria/fn_ajax_delete_data/" data-url="admin/galeria/"
...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
	<a class="btn-floating btn-large red modal-trigger waves-effect waves-circle waves-light tooltipped"
		data-position="left" data-delay="50" data-tooltip="Subir imagenes" href="#modal1">
