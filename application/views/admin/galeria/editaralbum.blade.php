				...
				<div class="panel-body">
					...
					<div class="form-group" id="g-Nombre">
						...
						<input class="form-control" id="Nombre" placeholder="Nombre" name="nombre"
							value="<?php echo $album[0]['nombre'] ?>" required="required" autofocus>
					</div>
					<div class="form-group">
						<label for="id_cazary" class="capitalize">Descripcion del Album:</label>
						<textarea class="form-control" id="id_cazary" placeholder="Descripcion del Album"
					...
					<div class="form-group input-group">
						...
						?>
						<input type="date" class="datepicker" placeholder="<?php echo $fecha->format('j F, Y') ?>"
							name="fecha" required="required" value="<?php echo $fecha->format('j F, Y') ?>">
					</div>
					<div class="col s12">
						Publicar album
						<!-- Switch -->
						<div class="switch">
							<label>
								...
								<input type="checkbox" name="estatus"
									<?php if ( $album[0]['estatus'] == 'Publicado'): ?> checked="checked"
									<?php endif ?>>
					...
					<div class="form-group" id="buttons">
						<button type="submit" class="btn btn-primary"><i
								class="material-icons right">done</i>Guardar</button>
