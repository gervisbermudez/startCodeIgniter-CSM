	...
	<div class="row">
		...
		<div class="col s12">
						...
						<ul id='<?php echo "$ddmid" ?>' class='dropdown-content'>
							...
							<li>
								<a href="#<?php echo $modalid;?>" class="modal-trigger"
									data-action-param='{"id":"<?php echo $value['id'] ?>", "table":"album"}'
									data-url="admin/galeria/fn_ajax_delete_data/" data-ajax-action="inactive"
									data-target-selector="<?php echo "#$itemid"; ?>">Eliminar</a>
							</li>
							<?php endif ?>
							<li><a href="<?php echo base_url('admin/galeria/editaralbum/'.$value['id']); ?>"> Editar</a>
							</li>
						</ul>
						<a class="card-content <?php echo random_element($quotes); ?> <?php echo random_element($deep); ?>"
							href="<?php echo base_url('admin/galeria/albumes/'.$value['id']); ?>">
			...
			<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
				<a class="btn-floating btn-large red waves-effect waves-circle waves-light new tooltipped "
					data-position="left" data-delay="50" data-tooltip="Crear Álbum"
					href="<?php echo base_url('admin/galeria/crearalbum/'); ?>"><i class="material-icons">add</i>
				</a>
			</div>
		</div>
	</div>
