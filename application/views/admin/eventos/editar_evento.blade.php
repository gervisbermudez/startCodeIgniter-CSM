...
<div class="container">
	<div class="row">
		<form action="<?php echo base_url('index.php/Admin/Eventos/update/'.$eventdata['id']);?>" method="post"
			id="form" class="col s12 m10 l10">
			<span class="header grey-text text-darken-2">Información <i
					class="material-icons left">description</i></span>
			<div class="input-field">
				<label for="nombre">Nombre:</label>
				<input type="text" id="nombre" name="nombre" required="required"
					value="<?php echo $eventdata['nombre'] ?>">
			</div>
			<div class="input-field">
				<label for="titulo">Titulo:</label>
				<input type="text" id="titulo" name="titulo" required="required"
					value="<?php echo $eventdata['titulo'] ?>">
			</div>
			...
			<div id="initialization" class="section scrollspy">
				...
				<div class="input-field">
					<?php 
						 ...
						 ?>
					<input type="date" placeholder="Fecha del evento" class="datepicker" id="publishdate"
						name="publishdate" required="required" value="<?php echo $fecha->format('j F, Y')  ?>">
				</div>
				<div class="input-field">
			...
			<div class="input-field">
				<input type="text" id="imagen" class="modal-trigger" name="imagen" placeholder="Imagen principal"
					data-target="modal1" value="<?php echo $eventdata['imagen'] ?>" data-expected="inactive">
			</div>
			<div id="structure" class="section scrollspy">
				<div class="input-field">
					<input type="text" data-target="modal1" id="thumb" name="thumb" class="modal-trigger"
						placeholder="Imagen Thumb" value="<?php echo $eventdata['thumb'] ?>" data-expected="inactive">
				</div>
			...
			<div class="form-group">
				...
				<div class="switch">
					<label>
						No publicado
						<input type="checkbox" name="sstatus" value="on"
							<?php if ($eventdata['status'] == "1"): ?>checked="checked" <?php endif ?>>
