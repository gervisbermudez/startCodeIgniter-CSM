...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="material-icons right">pageview</i>&nbsp;',
        browseClass: 'light-blue btn waves-effect waves-light',
        removeIcon: '<i class="material-icons right">delete</i>',
        removeClass: 'red darken-1 btn waves-effect waves-light',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="material-icons right">done</i>',
